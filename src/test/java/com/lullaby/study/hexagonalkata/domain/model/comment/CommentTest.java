...
class CommentTest {
    ...
    void success_write_comment() {
        Comment comment = Comment.write(1L, 1L, "comment");
    ...
    void fail_write_comment_1() {
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(null, 1L, "comment"));
    }
    ...
    void fail_write_comment_3() {
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(1L, 1L, null));
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(1L, 1L, ""));
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(1L, 1L, "  "));
    }
