...
import static com.lullaby.study.hexagonalkata.domain.model.article.ArticleMock.게시글_1;
...
class CommentTest {
    ...
    void success_write_comment() {
        Comment comment = Comment.write(게시글_1, 멤버_1, "comment");
    ...
    void fail_write_comment_2() {
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(게시글_1, null, "comment"));
    }

    @DisplayName("댓글 본문을 입력 하지 않으면 댓글 작성에 실패 한다.")
    @Test
    void fail_write_comment_3() {
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(게시글_1, 멤버_1, null));
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(게시글_1, 멤버_1, ""));
        assertThrows(CommentFieldInvalidException.class, () -> Comment.write(게시글_1, 멤버_1, "  "));
    }
